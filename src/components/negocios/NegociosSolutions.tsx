...
export const NegociosSolutions: React.FC = () => {
  ...
  const solutions: Solution[] = [
      ...
      graphic: (
        <div className="w-full h-40 sm:h-48 rounded-xl bg-[#090E17] border border-white/[0.08] p-4 flex flex-col justify-between overflow-hidden relative group-hover:border-white/[0.2] transition-all">
          <div className="flex items-center justify-between border-b border-white/[0.06] pb-2">
            <span className="text-xs font-mono text-[#CBD5E1] font-semibold">FLUJO DE AUTOMATIZACIÓN</span>
    ...
    },
    {
      ...
      graphic: (
        <div className="w-full h-40 sm:h-48 rounded-xl bg-[#090E17] border border-white/[0.08] p-4 flex flex-col justify-between overflow-hidden relative group-hover:border-white/[0.2] transition-all">
          <div className="flex items-center justify-between border-b border-white/[0.06] pb-2">
            <span className="text-xs font-mono text-[#CBD5E1] font-semibold flex items-center gap-1">
          ...
          <div className="space-y-2 my-auto">
            <div className="p-2 rounded-lg bg-white/[0.04] text-xs text-[#CBD5E1] max-w-[85%]">
              "Hola, ¿cuáles son los horarios y disponibilidad de turnos?"
            </div>
            <div className="p-2 rounded-lg bg-[#122238] border border-blue-500/30 text-xs text-white max-w-[90%] ml-auto text-right">
    ...
    },
    {
      ...
      graphic: (
        <div className="w-full h-40 sm:h-48 rounded-xl bg-[#090E17] border border-white/[0.08] p-4 flex flex-col justify-between overflow-hidden relative group-hover:border-white/[0.2] transition-all">
          <div className="flex items-center justify-between border-b border-white/[0.06] pb-2">
            <span className="text-xs font-mono text-[#CBD5E1] font-semibold">MIS CLIENTES Y VENTAS</span>
            <span className="text-[10px] font-mono text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded-full border border-emerald-500/20">
          ...
          <div className="grid grid-cols-3 gap-2 my-auto text-center">
            <div className="p-2 rounded-lg bg-white/[0.03] border border-white/[0.05]">
              <span className="text-[9px] text-[#8892B0] block">Consultas</span>
              <span className="text-xs font-bold text-white">18</span>
            </div>
            <div className="p-2 rounded-lg bg-white/[0.03] border border-white/[0.05]">
              <span className="text-[9px] text-[#8892B0] block">Presupuestos</span>
    ...
    },
    {
      ...
      graphic: (
        <div className="w-full h-40 sm:h-48 rounded-xl bg-[#090E17] border border-white/[0.08] p-4 flex flex-col justify-between overflow-hidden relative group-hover:border-white/[0.2] transition-all">
          <div className="flex items-center justify-between border-b border-white/[0.06] pb-2">
            <span className="text-xs font-mono text-[#CBD5E1] font-semibold">AGENDA DE CITAS</span>
          ...
          <div className="space-y-2 my-auto">
            <div className="flex items-center justify-between p-2 rounded-lg bg-white/[0.03]">
              <span className="text-xs text-[#CBD5E1]">Citas Confirmadas esta semana</span>
    ...
    },
    {
      ...
      graphic: (
        <div className="w-full h-40 sm:h-48 rounded-xl bg-[#090E17] border border-white/[0.08] p-4 flex flex-col justify-between overflow-hidden relative group-hover:border-white/[0.2] transition-all">
          <div className="flex items-center justify-between border-b border-white/[0.06] pb-2">
            <span className="text-xs font-mono text-[#CBD5E1] font-semibold">SISTEMA CONECTADO</span>
            <span className="text-[10px] font-mono text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded-full border border-amber-500/20">
              Sincronizado
            </span>
          </div>
          <div className="flex items-center justify-around my-auto text-xs text-white">
            <div className="px-2.5 py-1.5 rounded-lg bg-white/[0.05] border border-white/[0.1]">WhatsApp</div>
            <span className="text-amber-400 font-bold">↔</span>
            <div className="px-2.5 py-1.5 rounded-lg bg-amber-500/10 border border-amber-500/30 text-amber-200">ANSUZ</div>
            <span className="text-amber-400 font-bold">↔</span>
            <div className="px-2.5 py-1.5 rounded-lg bg-white/[0.05] border border-white/[0.1]">Planillas</div>
          </div>
        </div>
      ),
    },
    {
      ...
      graphic: (
        <div className="w-full h-40 sm:h-48 rounded-xl bg-[#090E17] border border-white/[0.08] p-4 flex flex-col justify-between overflow-hidden relative group-hover:border-white/[0.2] transition-all">
          <div className="flex items-center justify-between border-b border-white/[0.06] pb-2">
            <span className="text-xs font-mono text-[#CBD5E1] font-semibold">PLAN A TU MEDIDA</span>
          ...
          <div className="space-y-2 my-auto">
            <div className="p-2 rounded-lg bg-white/[0.03] border border-white/[0.05] flex items-center justify-between">
              <span className="text-xs text-white font-medium">🎯 Digitalización de mi Negocio</span>
  ...
  return (
    <Section id="soluciones" spacing="comfortable" className="relative bg-[#0E141D] py-24 md:py-32 overflow-hidden">
                ...
                <div className="relative group w-full flex flex-col justify-between rounded-2xl md:rounded-3xl border border-white/[0.08] bg-[#0C121C]/80 backdrop-blur-md p-6 sm:p-8 transition-all duration-350 hover:border-white/[0.22] hover:bg-[#111826]/90 hover:shadow-[0_25px_60px_rgba(0,0,0,0.6)] hover:-translate-y-1.5">
                  ...
                  <div className="relative pt-6 mt-6 border-t border-white/[0.06]">
                    <button
                      ...
                      className="inline-flex items-center justify-between w-full px-5 py-3.5 rounded-xl bg-[#141C2B] border border-white/[0.1] text-xs sm:text-sm font-semibold tracking-wide text-[#E6E8EB] hover:bg-[#1E2A40] hover:border-white/[0.25] hover:text-white transition-all duration-250 shadow-sm"
                    >
