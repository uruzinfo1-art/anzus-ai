    ...
    <Section spacing="comfortable" className="relative bg-[#FFFFFF] py-24 md:py-32 overflow-hidden">
      ...
      <Container maxWidth="2xl" className="relative z-10">
              ...
              return (
                ...
                >
                  ...
                  <div className="w-full md:w-1/2">
                    <div className="relative group rounded-2xl md:rounded-3xl border border-white/[0.08] bg-[#FFFFFF]/80 backdrop-blur-md p-6 sm:p-8 transition-all duration-300 hover:border-white/[0.22] hover:bg-[#FFFFFF]/90 hover:-translate-y-1 shadow-lg">
                      <div className="flex items-center gap-3 mb-3">
                        <span className="w-8 h-8 rounded-xl bg-[#FFFFFF] border border-white/[0.1] text-xs font-bold text-blue-400 font-mono flex items-center justify-center">
                          0{step.num}
                        </span>
                  ...
                  {/* Step Badge Node */}
                  <div className="relative z-20 flex items-center justify-center w-10 h-10 rounded-full bg-[#FFFFFF] border-2 border-white/[0.2] text-white font-bold font-mono text-sm shrink-0 shadow-lg">
                    {step.num}
                  </div>
        ...
        <motion.div
          ...
          className="relative max-w-3xl mx-auto rounded-3xl border border-white/[0.12] bg-gradient-to-b from-[#FFFFFF] to-[#F7F8FA] p-8 sm:p-10 text-center shadow-2xl"
        >
